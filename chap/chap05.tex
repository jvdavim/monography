...
\begin{figure}[!htp] \label{fig:casos_confirmados_ma}
    \centering
...
\begin{figure}[!htp] \label{fig:temperatura_minima_diaria}
    \centering
...
\begin{figure}[!htp] \label{fig:temperatura_minima_diaria_ma}
    \centering
