...
Eu, \emph{João Victor Almeida Davim} CPF \emph{115.366.847-59}, autor da monografia \emph{Previsão de Séries Temporais com Redes Neurais sem Peso}, subscrevo para os devidos fins, as seguintes informações:\\
...
\begin{flushright}
    ...
    % \vspace{-cm}
        \centering{João Victor Almeida Davim}
